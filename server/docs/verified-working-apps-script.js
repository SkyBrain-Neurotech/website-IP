// VERIFIED WORKING - SkyBrain Form Data Logger - Google Apps Script
// This version is tested to work with the test files
...
function getISTTime() {
  // Use Google Apps Script's built-in timezone conversion
  const now = new Date();
  
  // Method: Use Utilities.formatDate with IST timezone (most reliable in Apps Script)
